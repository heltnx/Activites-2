...
const AddActivityModal: React.FC<AddActivityModalProps> = ({ onClose, onSave }) => {
  const initialCategory = Object.keys(ACTIVITY_CATEGORIES)[0] as keyof typeof ACTIVITY_CATEGORIES;
    ...
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        <div className="p-6 border-b">
          <h2 id="add-activity-title" className="text-2xl font-bold text-gray-800">Ajouter une activité</h2>
        </div>
